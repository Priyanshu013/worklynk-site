          ...
          <section className="why-section">
            ...
            <div className="features-grid">
              ...
              <div className="feature-card">
                ...
                <p className="feature-text">
                  Be visible to recruiters who value real credibility over just
                  words on paper.
                </p>
              </div>
            </div>
          ...
          <section className="how-section">
            ...
            <div className="steps-grid">
              ...
              <div className="step-card">
                ...
                <p className="step-text">
                  Receive valuable insights from peers and industry colleagues.
                </p>
              </div>
              <div className="step-card">
                ...
                <p className="step-text">
                  Watch your Trust Score increase as you demonstrate consistent
                  excellence.
                </p>
              </div>
            </div>
            ...
            <div className="founder-note-container">
              ...
              <div className="founder-note-content">
                <p className="founder-note-text">
                  Hi there! <br />
                  I'm the founder of WorkLynk. I've worked as a Business Analyst
                  and have a passion for building products that help people. The
                  buzz of Artificial Intelligence has definitely built a lot of
                  hype around the future of work. I'm excited to be a part of
                  this journey and build a product that helps people grow their
                  careers.
                </p>
              </div>
            </div>
